...
export const cfg: Array<Topic> = [
    ...
    },
    {
        title: 'Software Engineering', link: '/software-engineering', summary: 'Thoughts/obervations of the tech industry', active: true, articles: [
            ...
            {
                title: 'Auditing Complex Processes', link: '/complex-process-auditing', summary: 'Adding visibility into complex business processes', postedDate: parse('2024-07-06', 'yyyy-MM-dd', new Date()), active: true,
            },
            {
