...
export const metadata: Metadata = {
  title: "Matthew Dalby: Articles: Software Engineering: Applied Unit Testing",
};

export default async function ArticlePage() {
  const { selPath, selArticle } = getArticleData("/software-engineering", "/applied-unit-testing");
