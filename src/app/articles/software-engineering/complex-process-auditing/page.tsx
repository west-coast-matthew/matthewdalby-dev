    ...
    <ArticleTemplateLayout selPath={selPath} selArticle={selArticle}>
      ...
      <Fade>
        ...
        <p>
          ...
          <Link href="https://github.com/west-coast-matthew/blog-process-monitoring">
      ...
      <Fade>
        <h2>Tackling my first complex business logic routine</h2>
      ...
      <Fade>
        ...
        <ImageReference
          imgRef="/article-content/se/business-logic-monitoring/bpm-logging.png"
          description="Logging Approaches"
        />
        ...
        <ImageReference
          imgRef="/article-content/se/business-logic-monitoring/bpm-architecture.svg"
          description="Multiple agent scenario"
        />
      ...
      <Fade>
        ...
        <p>The application can be found at the following Github URL.</p>
        ...
        <p>
          ...
          ./src/loan-app-processor.ts. The <i>processLoanApplication</i> method
          ...
          implentation, we are working with <i>AsyncLocalStorage</i>, however
          for Java based apps, <i>ScopedValue</i> and <i>ThreadLocal</i> would
        ...
        <p>
          The <i>src/monitoring/</i> folder contains agent related files
        ...
        <p>
          ...
          The caller, in this case <i>AddressValidationService</i> needs only to
        ...
        <ImageReference
          imgRef="/article-content/se/business-logic-monitoring/final-report.png"
          description="Final Transaction Report"
        />
