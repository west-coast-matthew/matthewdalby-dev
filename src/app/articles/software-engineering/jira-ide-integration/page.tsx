...
export const metadata: Metadata = {
  title: "Matthew Dalby: Articles: Software Engineering: Jira Ide Integration",
};

export default async function ArticlePage() {
  const { selPath, selArticle } = getArticleData("/software-engineering", "/jira-ide-integration");
