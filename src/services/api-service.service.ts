 ...
 * @param articles
 */
export const formatActiveArticles = (
...
export const filterActiveTopics = (topics: Array<Topic>): Array<Topic> => {
  ...
  const filteredCollection: Topic[] = topics.filter(
    (item) => item.active === true
  );
  const sortedCollection: Topic[] = filteredCollection.sort((a, b) => {
    //const dateA = new Date(a.postedDate);
    //const dateB = new Date(b.postedDate);
    //return dateA.getTime() - dateB.getTime(); // Ascending order

    if (a.postedDate === undefined && b.postedDate === undefined) {
      return 0; // If both dates are undefined, consider them equal
    }
    if (a.postedDate === undefined) {
      return 1; // Place undefined dates after defined ones
    }
    if (b.postedDate === undefined) {
      return -1; // Place undefined dates after defined ones
    }
    return a.postedDate.getTime() - b.postedDate.getTime(); // Ascending order
    ...
    articles: [
      {
        ...
        postedDate: parse("2025-01-5", "yyyy-MM-dd", new Date()),
        active: true,
      },
      {
        ...
        articles: [
          {
            ...
            postedDate: parse("2025-01-01", "yyyy-MM-dd", new Date()),
            active: true,
          },
          {
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        postedDate: parse("2024-07-06", "yyyy-MM-dd", new Date()),
        active: true,
      },
      {
      ...
      },
      {
        ...
        postedDate: parse("2025-08-05", "yyyy-MM-dd", new Date()),
        active: true,
      },
      {
        ...
        postedDate: parse("2025-05-15", "yyyy-MM-dd", new Date()),
        active: true,
      },
      {
