...
date: "June 17, 2024"
excerpt: "Developing shared modules in Node.js"
readTime: "7 min read"
...
## How did we get to this state of complexity
...
## A barebones working implementation
          ...
          * Support for path aliasing for cleaner dependency references
          ...
          * Support for ESModule 'import/export' style syntax
...
### Creating the bundler file for exports
...
[code]
// This format will not produce VS code typechecking
import {someFunction} from 'somwhere';
export someFunction;

// Working format
export * from '@config/logger';
export * from './config/db';
export * from '@middleware/hola.middleware';
[/code]
...
### Publishing the module for consumers (Development mode)
          ...
          1. Ensure the 'name' in the package.json in your shared file
            has a meaningful name as other projects will reference it via this
            context.

          2. Change into the root directory of your share module. Execute the
          ...
          3. Change into any given consumer project, and execute the yarn link
          ...
          4. In both installation approaches, an element will appear under the
...
### Publishing the module for consumers (Production)
